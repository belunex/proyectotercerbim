...
|
*/
/*$config['base_url'] = 'http://localhost/AvanceWEB/proyecto/';//segundo cambio*/
...
|
*/
$config['encryption_key'] = 'Decode'; //esta llave de encritacion no sera para nuestros password si no para nuestras sesiones
